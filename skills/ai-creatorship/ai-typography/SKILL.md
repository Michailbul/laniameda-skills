...
python3 ~/.openclaw/skills/ai-typography/scripts/generate_specimen.py \
  --font "Manrope" \
  --weight "SemiBold" \
  --output ~/.openclaw/skills/ai-typography/specimens/manrope-semibold.png
```
...
uv run ~/.codex/skills/nano-banana-pro/scripts/generate_image.py \
  ...
  --input-image "~/.openclaw/skills/ai-typography/specimens/<font>-<weight>.png" \
